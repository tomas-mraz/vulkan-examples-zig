...
const Ray2Renderer = @import("ray2_renderer.zig").Ray2Renderer;

const app_name = "Ray Tracing glTF";
...
pub fn main() !void {
    ...
    // RT feature chain + descriptor indexing. Kept on the stack so Vulkan
    // device creation reads them before main returns.
    ...
    var renderer = Ray2Renderer.init(allocator);
